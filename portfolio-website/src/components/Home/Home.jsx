  ...
  return (
    <>
      <div className="flex">
        ...
        <div className="flex justify-center items-center content-center h-screen flex-3 bg-[#180133]">
          ...
          <div className="flex flex-col items-center">
            <div>
              <h1 className="lg:text-6xl md:text-5xl xl:text-8xl  font-bold pb-3 bg-linear-[160deg] from-purple-950 from-5% via-purple-600 via-50% to-pink-300 to-90% inline-block text-transparent bg-clip-text ">Hi! This is <br /> Satvik Vansh.</h1>
            </div>
      ...
      <div className="flex justify-center items-center content-center h-screen flex-3 bg-[#180133]">
        ...
        <div className="flex flex-col items-center">
          <div>
            <h1 className="text-9xl font-bold pb-3 bg-linear-[160deg] from-purple-950 from-5% via-purple-600 via-50% to-pink-300 to-90% inline-block text-transparent bg-clip-text ">Hi! This is <br /> Satvik Vansh.</h1>
          </div>
          <div>
            <p className="text-gray-600 text-l font-medium">Experienced Software Engineer specializing in Full <br />Stack Development, AI/ML, and Computer Vision. <br /> Available for hire for innovative software development <br /> projects and recruitment opportunities.</p>
          </div>
